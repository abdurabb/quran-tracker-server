...
const { getProfile, getAttendance, getClassData, getAttendanceByMonth } = require('../controller/user/Profile')
const { protectUser, } = require('../middleware/auth')
const { getReports, getToppers } = require('../controller/user/report')
const { getEducationLevel } = require('../controller/user/educationLevel')
